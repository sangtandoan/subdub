...
//
//	mockgen -source=./internal/service/user_service.go -destination=./mocks/service.go -package=mocks
//
...
import (
	...
	service "github.com/sangtandoan/subscription_tracker/internal/service"
...
func (m *MockUserService) GetUser(ctx context.Context, id uuid.UUID) (*service.GetUserResponse, error) {
	m.ctrl.T.Helper()
